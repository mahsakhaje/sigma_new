import 'package:sigma/models/send_document_body.dart';
...
class InsertOrderResponse {
  ...
  InsertOrderResponse({this.status, this.message, this.salesOrder});

  InsertOrderResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
