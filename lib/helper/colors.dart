...
class AppColors {
  ...
  static  Color orange = Color(0xFFFF4F01);

  static const Color darkGrey = Color(0xFF2C2C2C);
  static const Color blue = Color(0xFF2D3CD7);
  static const Color khatokhash = Color(0xFFFFD700); // Yellow
  static const Color taviz = Color(0xFFA020F0); // Purple
  static const Color safkari = Color(0xFFFFA500); // Orange
